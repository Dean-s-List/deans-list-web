...
const Step1 = () => {
  return (
    <div className="relative flex h-screen w-full flex-col bg-[url('/images/idea.jpg')] bg-cover bg-no-repeat" id="step1">
      <div className="flex h-full flex-col items-center justify-center mb-12 mt-12">
        ...
        <div className="lh-spc text-left font-tt mb-12 ml-48 mr-48 text-[2rem]">
          ...
          <li>Complete the onboarding missions and quests and work your way up to Level 5 on <Link rel="noopener noreferrer" target="_blank" className="lun" href="https://crew3.xyz/c/dldao/questboard">Crew3</Link>
          </li>
          <li>Purchase at least one $DEAN Token by swapping $GRAPE on <Link rel="noopener noreferrer" target="_blank" className="lun" href="https://app.strataprotocol.com/swap/6LyW1iUpfTPiMxSLMpKCxeAqXDz7nuWCfCNnEaSmibZ1">Strata</Link>
          </li>
          <li>Become a customer by purchasing one of our packages through the <Link rel="noopener noreferrer" target="_blank" className="lun" href="https://coinablepay.com/store/deans-list">Coinable store</Link>       
          </li>
          </ul>
          </p>
        </div>
