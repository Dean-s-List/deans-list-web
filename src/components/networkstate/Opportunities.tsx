  ...
  return (
    <div className="mt-40 mb-40 flex flex-wrap justify-center">
      <div className="max-w-md p-4">
        <div className="flex h-full flex-col rounded-lg bgclay p-8">
          <div className="mb-4 flex items-center">
            <div className="mr-3 inline-flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full text-black">
              <svg
